export default function Home() {
  const projects = [
    {
      name: "PokéGrid",
      description: "Try to find a Pokémon that matches the conditios on the top and left! Can you do it?",
      liveUrl: "/projects/poke-grid", 
    },
    {
      name: "Screenlog",
      description: "Your personal corner of cinema. Log what you've watched, explore top-rated classics, and dive into the details behind every film.",
      liveUrl: "/projects/screenlog",
    }
  ];
